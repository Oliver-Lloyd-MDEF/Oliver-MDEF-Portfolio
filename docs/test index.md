...
<div style="display:flex; width: 100%; align-items: flex-start; align-content: flex-start; gap: 10px; flex-wrap:wrap;">
    <div style="box-shadow: 2px 2px 0px 3px #181040;; display: flex; padding: 10px; flex-direction: column; align-items: flex-start; gap: 10px; width: 40%; height: 100%; object-fit: cover; background-color: rgb(255,255,255)" >
    <h2>About Me</h2>
