...
<aside>
🪙 Access to the platform requires a wallet account (this is a type of digital wallet that allows for the storage and transfer of cryptocurrencies) such as [MetaMask](https://metamask.io/).
