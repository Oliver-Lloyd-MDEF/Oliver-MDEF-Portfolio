...
<div class="image-grid">
  <img src="../images/16. Digital Prototyping for Design/02. Clay X Coffee Printing/test extrusions.jpg" class="grid-item" alt="print testing">
...
<figcaption> Our final successful test print </figcaption>
-->
...
I could see this idea going further, to the point of maybe creating little circular material kiosks in supermarkets where people bring their old coffee related waste and it’s sorted and shredded into new products that people could then buy back for a reduced rate to keep these materials in use.